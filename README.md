...
- Follow the [Run Selenium tests with JavaScript on TestMu AI](https://www.testmuai.com/support/docs/javascript-with-selenium-running-javascript-automation-scripts-on-testmu-selenium-grid/) for the full setup walkthrough.
